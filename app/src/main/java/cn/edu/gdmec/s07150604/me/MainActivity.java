package cn.edu.gdmec.s07150604.me;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initChooseDialog(){
        choose_dialog=new AlertDialog.Builder(seft).setTitle("选择城市").setPositiveButton("确定",
                new ChooseCityListener()).setNegativeButton("取消",null).create();
    ...
    private class ChooseCityListener implements DialogInterface.OnClickListener{
